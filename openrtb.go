...
type Regulations struct {
	Coppa NumberOrBool     `json:"coppa,omitempty"` // Flag indicating if this request is subject to the COPPA regulations established by the USA FTC, where 0 = no, 1 = yes.
	Ext   *json.RawMessage `json:"ext,omitempty"`
}
