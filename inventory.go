...
type Inventory struct {
	...
	PrivacyPolicy *NumberOrBool    `json:"privacypolicy,omitempty"` // Default: 1 ("1": has a privacy policy)
...
func (a *Inventory) GetPrivacyPolicy() NumberOrBool {
...
type App struct {
	...
	Paid     NumberOrBool `json:"paid,omitempty"`     // "1": Paid, "2": Free
}
...
type Site struct {
	...
	Mobile NumberOrBool `json:"mobile,omitempty"` // Mobile ("1": site is mobile optimised)
}
